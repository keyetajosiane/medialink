...
router.post('/administration_members', administration_membersControllers.insert); // Enregistre un nouvel apprenant dans la base de données
...
router.put('/administration_members/:poste', administration_membersControllers.updatePoste); // Met à jour un apprenant dans la base de données grace a son matricule
...
router.delete('/administration_members/:id', administration_membersControllers.deleteById); 
router.delete('/administration_members/:poste', administration_membersControllers.deleteByPoste); 
