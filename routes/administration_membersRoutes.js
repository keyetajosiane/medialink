...
router.get('/administration_members/:id/user', authMiddleware.authenticateToken, permissionMiddleware.userGetPermission,administration_membersControllers.getadministration_membersByUserId);
