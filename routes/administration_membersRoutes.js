...
router.get('/administration_members/:user_id/user', authMiddleware.authenticateToken, permissionMiddleware.userGetPermission,administration_membersControllers.getadministration_membersByUserId);
