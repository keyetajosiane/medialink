...
router.get('/departement/search', departementControllers.getdepartementByNom); // Affiche les détails d'un utilisateur
router.get('/departement/:departement_id', departementControllers.getdepartementById); // Affiche les détails d'un utilisateur
router.post('/departement/insert', departementControllers.insert); // Enregistre un nouvel utilisateur dans la base de données
